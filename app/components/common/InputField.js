...
function InputField({
    ...
    return (
        <View style={{ justifyContent: 'center', alignItems: 'center' }} >
            <View style={{ alignItems: "center", justifyContent: "center", flexDirection: "row", backgroundColor: backgroundColor, borderBottomColor: "#2B217F", borderTopColor: "#2B217F", borderRightColor: "#2B217F", borderLeftColor: "#2B217F", borderWidth: borderWidth, width: width, height: height, borderRadius: borderRadius, marginVertical: RFPercentage(0.7), }} >
                ...
                <TextInput
                    ...
                    style={{ flexWrap: 'wrap', left: RFPercentage(0.5), color: color, alignSelf: "center", fontFamily: fontFamily, fontSize: fontSize, width: width }}
                    {...otherProps}
                >
